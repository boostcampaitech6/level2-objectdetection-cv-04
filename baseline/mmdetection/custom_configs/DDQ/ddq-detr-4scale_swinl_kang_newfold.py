...
train_dataloader = dict(
    ...
    batch_size=1,
    dataset=dict(
        ann_file='k-fold-V2/train_fold_3.json',
        backend_args=None,
        data_prefix=dict(img=''),
        data_root='../../dataset/',
...
val_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='k-fold-V2/val_fold_3.json',
        backend_args=None,
        data_prefix=dict(img=''),
        data_root='../../dataset/',
        metainfo=dict(
    ...
    sampler=dict(shuffle=False, type='DefaultSampler'))
val_evaluator = dict(
    ann_file='../../dataset/k-fold-V2/val_fold_3.json',
    backend_args=None,
    classwise=True,
    format_only=False,
    metric='bbox',
...
visualizer = dict(
    ...
    vis_backends=[
        dict(
            init_kwargs=dict(name='Avengers_DDQ_new_fold', project='Detr'),
            type='WandbVisBackend'),
    ])
work_dir = './work_dirs/DDQ_newfold'
